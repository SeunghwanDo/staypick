...
UI: Dict[str, Dict[str, str]] = {
    "ko": {
        ...
        "tone": "톤/추가 지시(선택)",
        "output_lang": "🌍 출력 언어",
        "header_pill": "콘텐츠 재생산 스튜디오",
        "header_caption": "트렌드를 요약하고, 후킹하고, 포맷별로 재생산해 내 콘텐츠로 만듭니다.",
        "tab_feed": "🏠 피드",
        "tab_make": "✍️ 만들기",
        "tab_data": "📥 데이터(운영자)",
    ...
    "en": {
        ...
        "header_pill": "Content Repurpose Studio",
        "header_caption": "Summarize trends, add hooks, and repurpose into ready-to-publish formats.",
        "tab_feed": "🏠 Feed",
        "tab_make": "✍️ Create",
        "tab_data": "📥 Data (Admin)",
    ...
    "ja": {
        ...
        "tone": "トーン/追加指示(任意)",
        "output_lang": "🌍 出力言語",
        "header_pill": "コンテンツ再構成スタジオ",
        "header_caption": "トレンドを要約し、フックを付け、形式ごとに再構成して公開用に仕上げます。",
        "tab_feed": "🏠 フィード",
        "tab_make": "✍️ 作る",
        "tab_data": "📥 データ(管理者)",
    ...
    "es": {
        ...
        "header_pill": "Estudio de reutilización",
        "header_caption": "Resumimos tendencias, añadimos ganchos y las convertimos a formatos listos para publicar.",
        "tab_feed": "🏠 Feed",
        "tab_make": "✍️ Crear",
